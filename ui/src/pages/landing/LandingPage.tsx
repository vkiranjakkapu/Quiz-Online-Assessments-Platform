                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 rounded-lg shadow-sm border border-slate-300 dark:border-slate-700 overflow-hidden">
                        ...
                        <div className="p-5 md:p-6 order-2 md:order-1 flex flex-col gap-3">
                            ...
                            <input
                                ...
                                className="py-1 px-2 w-full rounded-full border border-slate-300 dark:border-slate-700 outline outline-slate-300 outline-offset-2 dark:outline-slate-600"
                                placeholder="email"
                                type="email"
                                name="email"
                                id="email"
